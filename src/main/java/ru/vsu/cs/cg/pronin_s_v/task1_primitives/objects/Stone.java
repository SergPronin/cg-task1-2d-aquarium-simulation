...
public class Stone implements Static {
    private final int centerX;    // X центра камня
    private final int centerY;    // координата Y центра камня
    private final int width;      // ширина камня
    private final int height;     // высота камня
    private final Color baseColor;// цвет камня
    ...
    public void draw(Graphics2D g2) {
        ...
        Shape stoneShape = new Ellipse2D.Double(
                centerX - width / 2.0,
                centerY - height / 2.0,
                width,
                height
        ...
        g2.setPaint(new GradientPaint(
                (float) centerX, (float) (centerY - height / 2.0), new Color(255, 255, 255, 180),
                (float) centerX, (float) (centerY + height / 3.0), new Color(255, 255, 255, 0)
        ));
        g2.fill(stoneShape);
        g2.setComposite(oldComp);
